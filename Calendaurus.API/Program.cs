...
builder.Services.AddTransient<IEntryTypeService, EntryTypeService>();
builder.Services.AddTransient<IEntryTypeRepository, EntryTypeRepository>();

builder.Services.AddTransient<ICalendarEntryService, CalendarEntryService>();
builder.Services.AddTransient<ICalendarEntryRepository, CalendarEntryRepository>();
